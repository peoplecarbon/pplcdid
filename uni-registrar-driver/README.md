...
The JSON structure above can be generated by using the `--simulate` option of the [PPLCDID CLI](https://github.com/peoplecarbon/pplcdid/tree/main/cli). Use the following command:
...
The JSON structure from above to invoke `POST /1.0/update` can then be generated by using the `--simulate` option of the [PPLCDID CLI](https://github.com/peoplecarbon/pplcdid/tree/main/cli) with the following command:
...
*Note:* with the `logs` option of the [PPLCDID CLI](https://github.com/peoplecarbon/pplcdid/tree/main/cli) it is possible to show the the complete log trail for a deactivated DID:
...
The JSON structure from above to invoke `POST /1.0/deactivate` can then be generated by using the `--simulate` option of the [PPLCDID CLI](https://github.com/peoplecarbon/pplcdid/tree/main/cli) with the following command:
